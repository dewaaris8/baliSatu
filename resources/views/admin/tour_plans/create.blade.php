    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                {{-- Tour Inclusion Form --}}
                <form method="POST" action="{{ route('admin.tour_plans.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div>
                        ...
                        <x-text-input id="day" class="block mt-1 w-full" type="number" name="day" :value="old('day')" required autofocus autocomplete="day" />
