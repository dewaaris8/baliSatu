...
<body class="font-poppins text-black">
    <section id="content" class="w-full mx-auto bg-blue min-h-screen">
        <div class="w-full min-h-screen flex flex-col items-center justify-center py-[46px] px-[28px] gap-8">
          <div class="w-full flex flex-col items-center justify-center py-[46px] px-[28px] gap-8 rounded-[20px] overflow-hidden relative mx-1">
            <img src="{{asset('assets/backgrounds/Success-Illustration.png')}}" class="w-[100px] h-[100px] object-cover" alt="background">
          </div>
