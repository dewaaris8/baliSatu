...
<body>
    <div class="w-full bg-[#15192d] mx-auto border-b-[2px] border-l-[2px] border-r-[2px] border-white shadow-md rounded-b-[20px] flex items-center justify-center h-[100px]">
    ...
    <section class="max-w-[1300px] mt-[100px] mx-auto">
        <div class="w-full">
    ...
    <section class="max-w-[1300px] mt-[100px] mx-auto">
        <div class="w-full flex justify-ev">
            <div class="flex-1  flex-col gap-2">
                ...
                <h1 class="lg:text-[32px] md:text-[32px] text-[25px] font-medium">Email Support</h1>
                <h4 class="text-[20px]">Our team can respond in real time.</h4>
            ...
            <div class="flex-1  flex-col gap-2">
                ...
                <h1 class="lg:text-[32px] md:text-[32px] text-[25px] font-medium">Visit Our Office</h1>
                <h4 class="text-[20px]">Visit our location in real life.</h4>
            ...
            <div class="flex-1 flex-col gap-2">
                ...
                <h1 class="lg:text-[32px] md:text-[32px] text-[25px] font-medium">Call Us Directly</h1>
                <h4 class="text">Available during working hours.</h4>
